...
insert into faculties (facultyId,fname,lname,gender,qualification,classId) values (11004,"Ramashankar","Pandey","Male","BBA",NULL);
...
insert into faculties (facultyId,fname,lname,gender,qualification,classId) values (11014,"Payal","Mishra","Female","BBA",1110);
insert into faculties (facultyId,fname,lname,gender,qualification,classId) values (11015,"Bhagyashree","Soni","Male","BBA",1111);
insert into faculties (facultyId,fname,lname,gender,qualification,classId) values (11016,"Shyam","Kumar","Male","BBA",1112);
